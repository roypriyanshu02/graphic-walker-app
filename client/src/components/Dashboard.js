      ...
      <header className="bg-gradient-to-r from-primary-600 via-primary-700 to-secondary-600 text-white shadow-large">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-2 tracking-tight">{APP_CONFIG.NAME}</h1>
              <p className="text-lg text-primary-100 max-w-2xl leading-relaxed">{APP_CONFIG.DESCRIPTION}</p>
            </div>
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center space-x-3 bg-white/10 hover:bg-white/20 rounded-xl px-4 py-3 transition-all duration-200 backdrop-blur-sm"
              >
              ...
              {/* Dropdown Menu */}
              {showProfileMenu && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-large border border-gray-200 py-2 z-50 animate-fade-in">
